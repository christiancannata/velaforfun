...
class MyExecuteMailJobsCommand extends ContainerAwareCommand
{
    ...
    {
        $this
            ->setName('app:newsletter:job:mail:send')
    ...
    protected function sendMails($jobs, InputInterface $input, OutputInterface $output, $mandantName)
    {
        ...
        foreach ($jobs as $job) {
            try {
                ...
                $this->getContainer()->get('mynewsletter.mailservice')->send($job);
