...
use Ibrows\Bundle\NewsletterBundle\Controller\MandantController;
/**
 * @Route("/mandant")
 */
class MyMandantController extends MandantController
{
    /**
    ...
    {
        return $this->get("mynewsletter.encryption.adapter.mcrypt");
    }
