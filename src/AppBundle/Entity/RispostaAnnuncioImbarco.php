...
/**
 * @ORM\Entity
 * @ORM\Table(name="risposta_annuncio_imbarco")
 */
class RispostaAnnuncioImbarco
{
    /**
     * @ORM\Id
    ...
    /**
     * @ManyToOne(targetEntity="AnnuncioImbarco")
     * @JoinColumn(name="id_annuncio_imbarco", referencedColumnName="id")
     **/
    protected $annuncio;
