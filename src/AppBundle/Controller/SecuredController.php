...
class SecuredController extends ConnectController {
	...
	public function registrationAction( Request $request, $key ) {
		...
		if ( $formHandler->process( $request, $form, $userInformation ) ) {
			...
			return $this->container->get( 'templating' )->renderResponse( 'AppBundle:Demo:connessione-effettuata.html.' . $this->getTemplatingEngine(),
				array(
		...
		return $this->container->get( 'templating' )->renderResponse( 'AppBundle:Demo:registrati.html.' . $this->getTemplatingEngine(),
			array(
				'key'             => $key,
	...
	public function connectServiceAction( Request $request, $service ) {
		...
		return $this->container->get( 'templating' )->renderResponse( 'AppBundle:Demo:conferma-iscrizione.html.' . $this->getTemplatingEngine(),
			array(
				'key'             => $key,
				'service'         => $service,
				'form'            => $form->createView(),
