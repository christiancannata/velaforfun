...
class DefaultController extends BaseController
{
    ...
    public function getArchivioJsonAction( Request $r)
    {
        ...
        foreach($articoli as $articolo){
            $array[]=array(
            "permalink"=>$articolo->getTitolo()."|/".$articolo->getCategoria()->getPermalink()."/".$articolo->getPermalink()."|/var/www/immagini/articoli/".$articolo->getImmagine()."|".strip_tags($articolo->getSottotitolo()),
